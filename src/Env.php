...
final class Env
{
    ...
    public const array MAP = [
        ...
        'MAIL_SIMPLY_SSO_ISSUE_URL' => ['sso.issue_url', 'string'],
        'MAIL_SIMPLY_SSO_REQUIRE_BINDING' => ['sso.require_binding', 'bool'],
        'MAIL_SIMPLY_LOGIN_FORM' => ['login.enabled', 'bool'],
        'MAIL_SIMPLY_LOGIN_DOMAIN' => ['login.domain', 'string'],
        'MAIL_SIMPLY_LOGIN_MAX_ATTEMPTS' => ['login.max_attempts', 'int'],
        'MAIL_SIMPLY_LOGIN_MAX_ATTEMPTS_PER_CLIENT' => ['login.max_attempts_per_client', 'int'],
        ...
        'MAIL_SIMPLY_THROTTLE_DIR' => ['storage.throttle', 'string'],
